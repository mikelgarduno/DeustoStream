...
public class DeustoStreamControllerUnitTest {
    ...
    void testUpdatePelicula_ValidData() {
        Long peliculaId = 1L;
        Pelicula peliculaDetails = new Pelicula("Updated Title", Generos.DRAMA, 150, 2021, "Updated Description", "updatedUrl");
        Pelicula updatedPelicula = new Pelicula("Updated Title", Generos.DRAMA, 150, 2021, "Updated Description", "updatedUrl");
    ...
    void testUpdatePelicula_NotFound() {
        Long peliculaId = 99L;
        Pelicula peliculaDetails = new Pelicula("Nonexistent", Generos.DRAMA, 120, 2020, "Nonexistent Description", "url");

        when(deustoStreamService.updatePelicula(peliculaId, peliculaDetails)).thenThrow(new RuntimeException("Not Found"));
    ...
    void testUpdateSeries_ValidData() {
        Long seriesId = 1L;
        Series seriesDetails = new Series("Updated Series", 2020, "Updated Description", Generos.DRAMA, null, "updatedUrl");
        Series updatedSeries = new Series("Updated Series", 2020, "Updated Description", Generos.DRAMA, null, "updatedUrl");
    ...
    void testUpdateSeries_NotFound() {
        Long seriesId = 99L;
        Series seriesDetails = new Series("Nonexistent Series", 2020, "Nonexistent Description", Generos.DRAMA, null, "url");
